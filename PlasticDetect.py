...
with st.container():
    st.expander(f"<h2 style='text-align: center; background-color:{color_reto}; padding: 5px; border-radius: 5px;'>¿Qué es MonomerFinder?</h2>", unsafe_allow_html=True)
    ...
    st.expander(f"<h2 style='text-align: center; background-color:{color_defi}; padding: 5px; border-radius: 5px;'>¿Qué son los microplásticos?</h2>", unsafe_allow_html=True)
    ...
    st.expander(f"<h2 style='text-align: center; background-color:{color_ries_con}; padding: 5px; border-radius: 5px;'>Riesgos y consecuencias</h2>", unsafe_allow_html=True)
