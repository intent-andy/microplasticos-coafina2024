...
with reto:
    ...
    st.markdown(f"<h2 style='text-align: center; background-color:{color_fondo_titulo_reto}; padding: 5px; border-radius: 5px;'>¿Qué es PlasticDetect?</h2>", unsafe_allow_html=True)
